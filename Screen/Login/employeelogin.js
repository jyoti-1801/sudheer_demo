...
export default function Employeelogin({navigation}) {
  ...
  <Subheader img={require('../../assets/image/employeelogo.png')} txt1='Welcome' txt2="Employee" />
  <View style={{alignItems:"center",...styles.loginheader}}>
    ...
    <View style={{flexDirection:"row",marginTop:5}}>
      ...
      <TouchableOpacity onPress={()=>navigation.navigate("employeesignup")} style={{marginLeft:10,justifyContent:"center"}}>
...
:null}
    ...
    <View style={{flexDirection:"row",marginTop:30}}>
      ...
      <TouchableOpacity onPress={()=>navigation.navigate('employeeforgotpassword')} style={{position:'absolute',right:15,top:8}}>
