       ...
       <View style={{marginHorizontal:windowWidth/25,backgroundColor:Color.white,elevation:10,borderRadius:10,shadowOffset:{width:2,height:3},shadowOpacity:0.6,shadowRadius:10,marginBottom:30,flex:1}}>
        ...
        <ScrollView bounces={false} scrollEventThrottle={16} showsVerticalScrollIndicator={false} contentContainerStyle={{marginHorizontal:windowWidth/40,justifyContent:"center"}}>
            ...
            <View style={{...styles.prjctdetailcontainer,marginTop:10}}>
                <Text style={{...styles.txt3}}>Cadastral Survey Village Wise</Text>
            </View>
...
{/*      
                ...
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Village Map</Text></Text>
               <View style={{backgroundColor:'black',height:130,width:250,alignItems:"center",justifyContent:"center"}}>
                ...
                <View style={{marginTop:20,flexDirection:"row",justifyContent:"space-between",}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Cadastral Map</Text></Text>
               <View style={{backgroundColor:'black',height:130,width:250,alignItems:"center",justifyContent:"center"}}>
                      <TouchableOpacity activeOpacity={0.6} style={{backgroundColor:"#BFBFBF",paddingHorizontal:30,alignItems:'center',justifyContent:'center',borderRadius:5,shadowOffset:{width:2,height:3},shadowColor:Color.white,shadowOpacity:0.5,shadowRadius:5,elevation:10 }}>
                          <Text style={{fontFamily:"Roboto-regular",fontSize:12,padding:10}}>Browse</Text>
                      </TouchableOpacity>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>LAQ Statement</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Land Award</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Crop Award</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Tree Award</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Land rate</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Crop Rate</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Horticulture Rate</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Tree Rate</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Other Rate</Text></Text>
           ...
           <View style={{flexDirection:'row',marginBottom:80,alignSelf:"center",marginTop:50}}>
               ...
               <Ripple onPress={()=>navigation.navigate('RouDetail')}rippleColor={Color.white} rippleDuration={500} style={{backgroundColor:Color.maroon,borderRadius:5,alignItems:"center",justifyContent:"center",marginLeft:10,width:80,paddingVertical:4,elevation:2,shadowOffset:{width:2,height:3},shadowOpacity:0.6,shadowRadius:2}}>
