     ...
     <Image style={{tintColor:"#197BBD"}} source={require("../../../assets/image/right.png")}/>
       ...
       <View style={{marginHorizontal:windowWidth/25,backgroundColor:Color.white,elevation:10,borderRadius:10,shadowOffset:{width:2,height:3},shadowOpacity:0.6,shadowRadius:10,marginBottom:30,flex:1}}>
        ...
        <ScrollView bounces={false} scrollEventThrottle={16} showsVerticalScrollIndicator={false} contentContainerStyle={{marginHorizontal:windowWidth/40,justifyContent:"center"}}>
            ...
            <View style={{...styles.prjctdetailcontainer,marginTop:40}}>
                <Text style={{...styles.txt3}}>Project Details</Text>
            </View>
 
            <View style={{...styles.itemcontainer}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Project Name</Text></Text>
                ...
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Project Description</Text></Text>
                <View style={{...styles.txtinput}}>
                ...
                <View style={{...styles.itemcontainer,marginTop:20}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Starting Date</Text></Text>
                <View style={{...styles.txtinput}}>
                <TextInput multiline keyboardType='default' placeholder='Choose Date' style={{fontSize:13,padding:0,paddingLeft:5}}/>
                </View>

                </View>
       
                <View style={{...styles.itemcontainer,marginTop:20}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Duration</Text></Text>
                <View style={{...styles.txtinput}}>
                <TextInput multiline keyboardType='default' placeholder='Choose Date' style={{fontSize:13,padding:0,paddingLeft:5}}/>
                </View>
                ...
                <View style={{...styles.itemcontainer,marginTop:20}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Payment Method</Text></Text>
                <View style={{...styles.txtinput}}>
                <Selector/>
                </View>
                ...
                <View style={{...styles.itemcontainer,marginTop:20}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Payment Description</Text></Text>
                <View style={{...styles.txtinput}}>
                <Selector/>
                </View>
...
{/* 
                ...
                <View style={{...styles.prjctdetailcontainer,marginTop:40}}>
                <Text style={{...styles.txt3}}>Company Details</Text>
            </View>
 
            <View style={{...styles.itemcontainer}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Company Name</Text></Text>
                <View style={{...styles.txtinput}}>
                ...
                <Ripple rippleDuration={500} rippleColor={Color.maroon} style={{...styles.btncontainer,paddingVertical:2}}>
                  <View style={{flexDirection:"row",alignItems:'center',width:"75%"}}>
                      <View style={{height:16,width:16,borderRadius:8,backgroundColor:Color.maroon,marginLeft:-10,alignItems:"center",justifyContent:"center"}}>
                          <Image tintColor={Color.white} style={{width:6,height:6}} source={require("../../../assets/image/plus.png")}/>
                          </View>
                      <Text style={{color:Color.maroon,fontSize:11,fontFamily:'Roboto-Medium',marginLeft:5}}>Add New Company</Text>
                  </View>
                </Ripple>
                ...
                <View style={{width:"60%",height:35,borderWidth:1,borderColor:'#BFBFBF',justifyContent:"center"}}>
                    <View style={{flexDirection:'row',alignItems:'center',height:"100%"}}>
                        ...
                        <Text style={{fontSize:12,color:'black',fontFamily:'Roboto-Medium'}}>+91</Text>
                     
                        </View>
                       
                        <TextInput keyboardType='number-pad' style={{paddingLeft:10}} placeholder='phone no'/>
                ...
                <View style={{...styles.txtinput}}>
                <TextInput  keyboardType='email-address' placeholder='Email' style={{fontSize:13,padding:0,paddingLeft:5}}/>
                </View>
                ...
                <View style={{...styles.itemcontainer,marginTop:20}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>State</Text></Text>
                <View style={{...styles.txtinput}}>
                <Selector/>
                </View>
                ...
                <View style={{...styles.itemcontainer,marginTop:20}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>City</Text></Text>
                <View style={{...styles.txtinput}}>
                <TextInput  placeholder='Enter City' style={{fontSize:13,padding:0,paddingLeft:5}}/>
                </View>

                </View>

                <View style={{...styles.itemcontainer,marginTop:20}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Pin Code</Text></Text>
                <View style={{...styles.txtinput,}}>
                <TextInput keyboardType='number-pad' placeholder='Enter Pincode' style={{fontSize:13,padding:0,paddingLeft:5}}/>
                </View>
                ...
                <View style={{...styles.itemcontainer,marginTop:20}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Address</Text></Text>
                <View style={{...styles.txtinput}}>
                <TextInput multiline placeholder='Address' style={{fontSize:13,padding:0,paddingLeft:5}}/>
                </View>
                ...
                <View style={{...styles.itemcontainer,marginTop:20}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>GST Number</Text></Text>
                <View style={{...styles.txtinput}}>
                <TextInput multiline placeholder='GST No' style={{fontSize:13,padding:0,paddingLeft:5}}/>
                </View>
...
{/* 
                ...
                <View style={{...styles.prjctdetailcontainer,marginTop:40}}>
                <Text style={{...styles.txt3}}>Client Details</Text>
            </View>
 
            <View style={{...styles.itemcontainer}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Client Name</Text></Text>
                <View style={{...styles.txtinput}}>
                <TextInput keyboardType='default'style={{fontSize:13,padding:0}}/>
                </View>
                ...
                <Ripple rippleDuration={500} rippleColor={Color.maroon} style={{...styles.btncontainer,paddingVertical:2}}>
                  <View style={{flexDirection:"row",alignItems:'center',width:"75%"}}>
                      ...
                      <Text style={{color:Color.maroon,fontSize:11,fontFamily:'Roboto-Medium',marginLeft:5}}>Add New Client</Text>
                  </View>
                </Ripple>
...
<View style={{...styles.prjctdetailcontainer,marginTop:40}}>
            ...
            <View style={{...styles.itemcontainer}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Project Manager Name</Text></Text>
                <View style={{...styles.txtinput,width:"55%"}}>
                <TextInput keyboardType='default' placeholder='Type here' style={{padding:0,fontSize:13,paddingLeft:5}}/>
                </View>
                ...
                <View style={{...styles.itemcontainer,marginTop:20}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Team Size</Text></Text>
                <View style={{...styles.txtinput}}>
                <TextInput multiline keyboardType='default' placeholder='Type here' style={{fontSize:13,padding:0,paddingLeft:5}}/>
                </View>
