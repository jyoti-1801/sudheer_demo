       ...
       <View style={{marginHorizontal:windowWidth/25,backgroundColor:Color.white,elevation:10,borderRadius:10,shadowOffset:{width:2,height:3},shadowOpacity:0.6,shadowRadius:10,marginBottom:30,flex:1}}>
        ...
        <ScrollView bounces={false} scrollEventThrottle={16} showsVerticalScrollIndicator={false} contentContainerStyle={{marginHorizontal:windowWidth/40,justifyContent:"center"}}>
            ...
            <View style={{...styles.prjctdetailcontainer,marginTop:10}}>
                <Text style={{...styles.txt3}}>ROU Details</Text>
            </View>
 
            <View style={{...styles.itemcontainer}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Village Wise</Text></Text>
                ...
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Taluka Name</Text></Text>
                <View style={{...styles.txtinput}}>
                <TextInput keyboardType='default' placeholder='Type here' style={{padding:0,fontSize:13,paddingLeft:5}}/>
                </View>
                ...
                <View style={{...styles.itemcontainer,marginTop:20}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>District Name</Text></Text>
                <View style={{...styles.txtinput}}>
                <TextInput keyboardType='default' placeholder='Type here' style={{padding:0,fontSize:13,paddingLeft:5}}/>
                </View>
                ...
                <View style={{...styles.itemcontainer,marginTop:20}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>State Name</Text></Text>
                <View style={{...styles.txtinput}}>
                <TextInput keyboardType='default' placeholder='Type here' style={{padding:0,fontSize:13,paddingLeft:5}}/>
                </View>
                ...
                <View style={{...styles.itemcontainer,marginTop:20}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Survey No</Text></Text>
                <View style={{...styles.txtinput}}>
                ...
                <View style={{...styles.itemcontainer,marginTop:20}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Land Type</Text></Text>
                <View style={{...styles.txtinput,}}>
...
{/*      
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>FMB</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>ROR</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>3 (1) Notice</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Objection</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>6 (1) Notice</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>JMS</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Panchnama</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Payment Document</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Land Payment Detail</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Crop Payment Detail</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>OtherPayment Detail</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>NOC</Text></Text>
           ...
           <View style={{flexDirection:'row',marginBottom:80,alignSelf:"center",marginTop:50}}>
               ...
               <Ripple onPress={()=>navigation.navigate("crossinddoc")} rippleColor={Color.white} rippleDuration={500} style={{backgroundColor:Color.maroon,borderRadius:5,alignItems:"center",justifyContent:"center",marginLeft:10,width:80,paddingVertical:4,elevation:2,shadowOffset:{width:2,height:3},shadowOpacity:0.6,shadowRadius:2}}>
