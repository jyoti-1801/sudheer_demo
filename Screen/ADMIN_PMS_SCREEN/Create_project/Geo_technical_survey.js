       ...
       <View style={{marginHorizontal:windowWidth/25,backgroundColor:Color.white,elevation:10,borderRadius:10,shadowOffset:{width:2,height:3},shadowOpacity:0.6,shadowRadius:10,marginBottom:30,flex:1}}>
        ...
        <ScrollView bounces={false} scrollEventThrottle={16} showsVerticalScrollIndicator={false} contentContainerStyle={{marginHorizontal:windowWidth/40,justifyContent:"center"}}>
            ...
            <View style={{...styles.prjctdetailcontainer,marginTop:10}}>
                <Text style={{...styles.txt3}}>Geo Technical Survey</Text>
            </View>
            ...
            <View style={{...styles.itemcontainer}}>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Bore Log Report</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Lab Test Result</Text></Text>
                ...
                <View style={{...styles.itemcontainer,marginTop:-10,width:"100%"}}>
                <Text style={{color:Color.maroon,fontFamily:"Roboto-Medium",fontSize:13}}>*<Text style={{color:Color.headcolor}}>Calculation Sheet</Text></Text>
           ...
           <View style={{flexDirection:'row',marginBottom:80,alignSelf:"center",marginTop:70}}>
               ...
               <Ripple onPress={()=>navigation.navigate("topograph")} rippleColor={Color.white} rippleDuration={500} style={{backgroundColor:Color.maroon,borderRadius:5,alignItems:"center",justifyContent:"center",marginLeft:10,width:80,paddingVertical:4,elevation:2,shadowOffset:{width:2,height:3},shadowOpacity:0.6,shadowRadius:2}}>
