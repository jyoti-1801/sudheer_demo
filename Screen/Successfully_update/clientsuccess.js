...
export default function Clientpaswrdcreate({navigation}) {
  const Clientlginagain=()=>{
    navigation.navigate('Clientlginagain')
  }
  return (
   ...
   <View style={{marginHorizontal:10,marginTop:30,flexDirection:"row",backgroundColor:Color.white,}}>
      ...
      <Text style={{color:Color.headcolor,fontFamily:"Roboto-Bold",fontSize:24}}>Password Updated</Text>
    
      <View style={{flexDirection:"row",marginTop:15,marginHorizontal:windowWidth/5}}>
        <Text style={{fontFamily:"Roboto-Medium",fontSize:13,color:Color.headcolor,textAlign:"center"}}>You Password Has been Updated Successfully !</Text>
   
      </View>
     
        </View>

 <View style={{marginTop:20,marginHorizontal:windowWidth/20,justifyContent:"center"}}>
   <Button onPress={Clientlginagain} title="Login"/>
