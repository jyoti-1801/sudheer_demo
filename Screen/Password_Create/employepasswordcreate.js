...
export default function Adminsignup({navigation}) {
 const employeepaswrdupdate=()=>{
   navigation.navigate('employeepaswrdupdate')
 }
  return (
   ...
   <View style={{marginHorizontal:10,marginTop:30,flexDirection:"row",backgroundColor:Color.white,}}>
      ...
      <View style={{flexDirection:"row",marginTop:10,marginHorizontal:windowWidth/10}}>
...
<View style={{...styles.txtinpt,justifyContent:"center"}}>
  ...
  <Button  onPress={employeepaswrdupdate} title="Submit"/>
