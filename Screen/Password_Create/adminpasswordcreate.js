...
export default function AdminsPasswordcreate({navigation}) {
  const adminpaswrdupdate=()=>{
    navigation.navigate('adminpaswrdupdate')
  }
  return (
...
<View style={{...styles.txtinpt,justifyContent:"center"}}>
  ...
  <Button onPress={adminpaswrdupdate} title="Submit"/>
