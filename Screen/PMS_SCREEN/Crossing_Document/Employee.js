...
<View style={{flexDirection:"row",alignItems:"center",paddingHorizontal:10}}>
    <TouchableOpacity style={{width:"55%"}} activeOpacity={0.6}>
     ...
     <Image style={{tintColor:"#197BBD"}} source={require("../../../assets/image/right.png")}/>
       <TouchableOpacity style={{}} activeOpacity={0.6}>
       <Text style={{color:Color.maroon,fontFamily:'Roboto-Medium',fontFamily:'Roboto-Medium',fontSize:10,margin:8}}>Crossing Document Detail </Text>
       </TouchableOpacity>
       </View>
       </View>
...
<View style={{marginHorizontal:windowWidth/30,marginTop:2,marginBottom:15}}>
