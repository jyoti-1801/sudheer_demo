...
<View style={{flexDirection:"row",alignItems:"center",paddingHorizontal:10}}>
    <TouchableOpacity style={{width:"55%"}} activeOpacity={0.6}>
     ...
     <Image style={{tintColor:"#197BBD"}} source={require("../../../assets/image/right.png")}/>
       ...
       <Text style={{color:Color.maroon,fontFamily:'Roboto-Medium',fontFamily:'Roboto-Medium',fontSize:13,margin:8}}>Topo Graphical Survey  </Text>
       </TouchableOpacity>
       </View>
       </View>
...
const styles = StyleSheet.create({
    headercontainer:{
        ...
        btncontainer:{
            height:30,backgroundColor:Color.maroon,alignSelf:'center',alignItems:"center",justifyContent:'center',borderRadius:20,marginBottom:30,width:'40%',marginTop:35,elevation:5,shadowOffset:{width:2,height:3},shadowRadius:10,shadowOpacity:0.6
        },
        btntxt:{
