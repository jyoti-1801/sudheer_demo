...
import Table from '../../../Screen/Table/index'
...
<View style={{flexDirection:"row",alignItems:"center",paddingHorizontal:10}}>
    <TouchableOpacity style={{width:"55%"}} activeOpacity={0.6}>
       <Text style={{color:Color.maroon,fontFamily:'Roboto-Medium',fontFamily:'Roboto-Medium',fontSize:12,margin:8,}}>Document Management system  </Text>
       </TouchableOpacity>
       ...
       <Text style={{color:Color.maroon,fontFamily:'Roboto-Medium',fontFamily:'Roboto-Medium',fontSize:12,margin:8}}>View </Text>
       </TouchableOpacity>
     <Image style={{tintColor:"#197BBD"}} source={require("../../../assets/image/right.png")}/>
       <TouchableOpacity style={{}} activeOpacity={0.6}>
       <Text style={{color:Color.maroon,fontFamily:'Roboto-Medium',fontFamily:'Roboto-Medium',fontSize:10,margin:8}}>Fund Reimbursement </Text>
       </TouchableOpacity>
       </View>
       </View>
       ...
       <View style={{flexDirection:'row',...styles.Selectitmcontainer}}>
           <Text style={{...styles.txt,width:"30%"}}>Client Name</Text> 
     <View style={{width:"70%"}}>
       <Selector />
       </View>
       </View>
...
<View style={{marginHorizontal:windowWidth/30,marginTop:30}}>
    <Text style={{...styles.txt,fontFamily:"Roboto-Bold"}}>Master Form</Text>
<Table/>
</View>

<View style={{marginHorizontal:windowWidth/30,marginTop:30}}>
    <Text style={{...styles.txt,fontFamily:"Roboto-Bold"}}>Notification</Text>
<Table/>
</View>

<View style={{marginHorizontal:windowWidth/30,marginTop:30}}>
    <Text style={{...styles.txt,fontFamily:"Roboto-Bold"}}>Notice</Text>
<Table/>
</View>

<View style={{marginHorizontal:windowWidth/30,marginTop:30}}>
    <Text style={{...styles.txt,fontFamily:"Roboto-Bold"}}>Objection</Text>
<Table/>
</View>

<View style={{marginHorizontal:windowWidth/30,marginTop:30}}>
    <Text style={{...styles.txt,fontFamily:"Roboto-Bold"}}>Compensation</Text>
<Table/>
</View>

<View style={{marginHorizontal:windowWidth/30,marginTop:30}}>
    <Text style={{...styles.txt,fontFamily:"Roboto-Bold"}}>Report</Text>
<Table/>
</View>

<View style={{marginBottom:10,marginHorizontal:windowWidth/30,marginTop:30}}>
    <Text style={{...styles.txt,fontFamily:"Roboto-Bold"}}>Upload</Text>
<Table/>
</View>
       </ScrollView>
...
const styles = StyleSheet.create({
    headercontainer:{
        ...
        btncontainer:{
            height:30,backgroundColor:Color.maroon,alignSelf:'center',alignItems:"center",justifyContent:'center',borderRadius:20,marginBottom:10,width:'40%',marginTop:35
        },
        btntxt:{
