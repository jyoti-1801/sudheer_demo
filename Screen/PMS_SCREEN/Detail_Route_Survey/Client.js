...
<View style={{flexDirection:"row",alignItems:"center",paddingHorizontal:10}}>
    <TouchableOpacity style={{width:"55%"}} activeOpacity={0.6}>
     ...
     <Image style={{tintColor:"#197BBD"}} source={require("../../../assets/image/right.png")}/>
       ...
       <Text style={{color:Color.maroon,fontFamily:'Roboto-Medium',fontFamily:'Roboto-Medium',fontSize:13,margin:8}}>Detail Route Survey  </Text>
       </TouchableOpacity>
       </View>
       </View>
...
<View style={{marginHorizontal:windowWidth/30,marginBottom:15,}}>
 ...
 <Text style={{...styles.txt,fontFamily:"Roboto-Bold",color:Color.headcolor,marginTop:10}}>Alignment Sheets </Text>
<Table/>
</View>
...
<View style={{marginHorizontal:windowWidth/30,marginBottom:15,}}>
 ...
 <Text style={{...styles.txt,fontFamily:"Roboto-Bold",color:Color.headcolor,marginTop:10}}>Cross Section </Text>
<Table/>
</View>

<View style={{marginHorizontal:windowWidth/30,marginBottom:15,marginBottom:180}}>

 <Text style={{...styles.txt,fontFamily:"Roboto-Bold",color:Color.headcolor,marginTop:10}}>Route Maps </Text>
<Table/>
</View>
