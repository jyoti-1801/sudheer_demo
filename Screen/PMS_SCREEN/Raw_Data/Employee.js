...
<View style={{flexDirection:"row",alignItems:"center",paddingHorizontal:10}}>
    <TouchableOpacity style={{width:"55%"}} activeOpacity={0.6}>
     ...
     <Image style={{tintColor:"#197BBD"}} source={require("../../../assets/image/right.png")}/>
       <TouchableOpacity style={{}} activeOpacity={0.6}>
       <Text style={{color:Color.maroon,fontFamily:'Roboto-Medium',fontFamily:'Roboto-Medium',fontSize:13,margin:8}}>Raw Data </Text>
       </TouchableOpacity>
       </View>
       </View>
...
<View style={{marginHorizontal:windowWidth/30,marginTop:10}}>
    <Text style={{...styles.txt,fontFamily:"Roboto-Bold"}}>Route Survey Data</Text>
<Table/>
</View>

<View style={{marginHorizontal:windowWidth/30,marginTop:30}}>
    <Text style={{...styles.txt,fontFamily:"Roboto-Bold"}}>DGPS Survey Data</Text>
<Table/>
</View>

<View style={{marginHorizontal:windowWidth/30,marginTop:30}}>
    <Text style={{...styles.txt,fontFamily:"Roboto-Bold"}}>Levelling Data</Text>
<Table/>
</View>

<View style={{marginHorizontal:windowWidth/30,marginTop:30,marginBottom:150}}>
    <Text style={{...styles.txt,fontFamily:"Roboto-Bold"}}>Pipeline Locating</Text>
<Table/>
</View>
       </ScrollView>
