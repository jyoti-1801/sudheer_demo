...
export default function Clientverify({navigation}) {
  const clientotp=()=>{
    navigation.navigate('clientotp')
  }

  const clientchangeemail=()=>{
    navigation.navigate('clientchangeemail')
  }
  return (
 ...
 <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? "padding" : "height"}  style={{marginTop:20,marginHorizontal:windowWidth/20,justifyContent:"center"}}>
   <Button onPress={clientotp} title="Send Verification Code"/>
   <Button2 onPress={clientchangeemail} title="Change Email Id"/>
