...
export default function Clientforgot({navigation}) {
  ...
  return (
   ...
   <Header  img1={require("../../assets/image/back.png")} img2={require("../../assets/image/logo.png")}/>
...
<KeyboardAvoidingView behavior={Platform.OS === 'ios' ? "padding" : "height"}  style={{marginTop:50,marginHorizontal:windowWidth/20,justifyContent:"center"}}>
  <View>
  <TextInput placeholder='Enter your new email' style={{...styles.txtinpt}}/>
  
          
  </View>
  <Button onPress={()=>navigation.navigate('OTPclient')} title="Request OTP"/>
