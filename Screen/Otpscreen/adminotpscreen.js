...
export default function Adminotp({navigation}) {
  const adminpasswordcreate=()=>{
    navigation.navigate('adminpasswordcreate')
  }
    const pin1 = useRef("");
    const pin2 = useRef("");
    const pin3 = useRef("");
 ...
 <View style={{ alignItems:"center",justifyContent:"center",flexDirection:"row",alignSelf:"center"}}>
   ...
   <Button onPress={adminpasswordcreate} title="Verify Code"/>
