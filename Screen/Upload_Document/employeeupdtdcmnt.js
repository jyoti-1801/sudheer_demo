...
<View style={{flexDirection:"row",alignItems:"center",justifyContent:"space-between"}}>
    <TouchableOpacity activeOpacity={0.6}>
     ...
     <Image style={{tintColor:"#197BBD",position:'absolute',right:170}} source={require("../../assets/image/right.png")}/>
       ...
       <View style={{marginHorizontal:windowWidth/25,height:700,backgroundColor:Color.white,elevation:10,borderRadius:10,shadowOffset:{width:2,height:3},shadowOpacity:0.6,shadowRadius:10,marginBottom:30}}>
        ...
        <ScrollView bounces={false} scrollEventThrottle={16} showsVerticalScrollIndicator={false} contentContainerStyle={{}}>
     ...
     <View style={{width:"70%",justifyContent:"center",borderWidth:1,height:25}}>
       ...
       <View style={{flexDirection:'row',...styles.Selectitmcontainer}}>
           <Text style={{...styles.txt,width:"30%"}}>MCR</Text> 
     <View style={{width:"70%"}}>
       <Selector />
       </View>
       </View>
       ...
       <View style={{flexDirection:'row',...styles.Selectitmcontainer}}>
           <Text style={{...styles.txt,width:"30%"}}>Section</Text> 
     <View style={{width:"70%"}}>
       <Selector />
       </View>
       </View>
       ...
       <View style={{flexDirection:'row',...styles.Selectitmcontainer}}>
           <Text style={{...styles.txt,width:"30%"}}>Station</Text> 
     <View style={{width:"70%"}}>
       <Selector />
       </View>
       </View>
       ...
       <View style={{flexDirection:'row',...styles.Selectitmcontainer}}>
           <Text style={{...styles.txt,width:"30%"}}>Base</Text> 
     <View style={{width:"70%"}}>
       <Selector />
       </View>
       </View>
       ...
       <View style={{flexDirection:'row',...styles.Selectitmcontainer}}>
           <Text style={{...styles.txt,width:"30%"}}>General Type</Text> 
     <View style={{width:"70%"}}>
       <Selector />
       </View>
       </View>
       ...
       <View style={{flexDirection:'row',...styles.Selectitmcontainer}}>
           <Text style={{...styles.txt,width:"30%"}}>Category</Text> 
     <View style={{width:"70%"}}>
       <Selector />
       </View>
       </View>
       ...
       <View style={{flexDirection:'row',...styles.Selectitmcontainer}}>
           <Text style={{...styles.txt,width:"30%"}}>Sub Category</Text> 
     <View style={{width:"70%"}}>
       <Selector />
       </View>
       </View>
       ...
       <View style={{flexDirection:'row',...styles.Selectitmcontainer}}>
           <Text style={{...styles.txt,width:"30%"}}>Micro Category</Text> 
     <View style={{width:"70%"}}>
       <Selector />
       </View>
       </View>
...
<Ripple onPress={()=>navigation.navigate("Successfully_uploaded")} rippleColor={Color.white} rippleDuration={500} style={{...styles.btncontainer}}>
...
const styles = StyleSheet.create({
    headercontainer:{
        ...
        btncontainer:{
            height:30,backgroundColor:Color.maroon,margin:25,alignItems:"center",justifyContent:'center',borderRadius:20,marginBottom:100
        },
        btntxt:{
